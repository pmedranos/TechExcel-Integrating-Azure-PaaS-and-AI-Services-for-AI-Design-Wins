...
[KernelFunction]
    [Description("Get bookings that do not have associated hotel rooms.")]
...
[KernelFunction]
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the Hotel")]int hotelId, [Description("The date and time")]DateTime dt)
    {
